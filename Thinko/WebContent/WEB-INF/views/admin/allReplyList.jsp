...
<body>
	...
	<div class="container-fluid mt-5">
		<div class="row">
			...
			<div class="col-md-8">
				<div class="row">
					<div class="col-md-12">
						<h2 class="title-1 m-b-25">모든 댓글</h2>
						...
						<c:choose>
							...
							<c:when test="${!empty param.sk && !empty param.sv }">
								<c:url var="pageUrl" value="/adminSearch/allReplySearch.do" />
							...
							<c:otherwise>
								<c:url var="pageUrl" value="/admin/allReplyList.do" />
							</c:otherwise>
						</c:choose>
	...
	<div class="my-5">
		<form action="${contextPath}/adminSearch/allReplySearch.do" method="GET"
	...
	<script>
		$(".table td").on("click", function() {
			...
			var url = "${contextPath}/board1/boardView.do?cp=${pInfo.currentPage}&no=" + boardNo + "${searchStr}&adr=1";
